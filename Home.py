...
def page():
    hide_multipage_nav()
    top_nav("Home")   # esta página é a Home
# =========================================================
...
.header-strip {
  ...
  padding:10px 20px; border-radius:12px; font-size:14px; letter-spacing:0.2px;
}
...
cards = [
    ...
    {"k":"3","title":"Relatorios","icon":"📑","hint":"Emitir PDFs e planilhas","path":"pages/Relatorios.py"},
